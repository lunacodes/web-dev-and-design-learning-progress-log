...
```powershell
# from: http://www.powershellmagazine.com/2014/03/04/pstip-restarting-powershell-as-an-administrator/
# see also: https://stackoverflow.com/questions/44668792/restart-powershell-with-admin-rights-and-continue-with-current-script
